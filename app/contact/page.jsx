...
export default function Form() {
  ...
  const sendEmail = (params) => {
    ...
    emailjs
      .send(
        process.env.NEXT_PUBLIC_SERRVICE_ID,
  ...
  return (
    <div className="px-7 py-14 gap-7 flex mx-auto">
      <div className="w-1/2">
      ...
      <div className="w-1/2">
        <div className="text-orange-200">
          <p className="text-sm uppercase font-semibold mb-4 tracking-[4px] ">
            Say,, hellow
          </p>
          <Laugh />
        </div>
        <h1 className="text-3xl mt-4 mb-4 text-orange-400">
          Lets Work Together{" "}
        </h1>
        {/* <p className="text-lg mb-8 font-light max-w-[490px] mx-auto xl:mx-0">
          Web developer with a passion for web application development. Interest
          in exploring new technologies and problem solving.
        </p> */}
      </div>
    </div>
  );
